...
import com.Dating.Course.entity.BoardFileEntity;
import com.Dating.Course.repository.BoardFileRepository;
...
//            String savePath = "/Users/사용자이름/springboot_img/" + storedFileName; // C:/springboot_img/9802398403948_내사진.jpg
    ...
    @Transactional
    public void updateHeartHits(Long id) {
        boardRepository.updateHeartHits(id);
    }
    ...
    public Page<BoardDTO> paging(Pageable pageable) {
        ...
        Page<BoardDTO> boardDTOS = boardEntities.map(board -> new BoardDTO(board.getId(), board.getBoardWriter(), board.getBoardTitle(), board.getBoardHits(),board.getHeartHits(), board.getCreatedTime()));
        return boardDTOS;
    }
}